    ...
    <div class="trade-container">
      ...
      <div class="content">
        ...
        <div class="address clearFix" v-for="item in addresslist" :key="item.id">
          ...
          <p @click="changeaddress(item,addresslist)">
        ...
        <div class="detail">
          <h5>商品清单</h5>
          <ul class="list clearFix" v-for="(item,index) in tradelist.detailArrayList" :key="index">
            <li>
      ...
      <div class="trade">
        ...
        <div class="receiveInfo">
          寄送至:
          <span>{{this.defultaddress.fullAddress}}</span>
          收货人：<span>{{this.defultaddress.consignee}}</span>
          <span>{{this.defultaddress.phoneNum}}</span>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async gettradelist () {
      await this.$store.dispatch('gettradelist')
    },
    changeaddress (item, list) {
    ...
    async submitorder () {
      ...
      const data = {
        ...
        deliveryAddress: this.defultaddress.fullAddress,
        paymentWay: 'ONLINE',
